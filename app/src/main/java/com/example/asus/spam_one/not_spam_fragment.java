...
public class not_spam_fragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    @BindView(R.id.not_spam_list_text)
    TextView txt;
    @BindView(R.id.not_spam_list)
    ListView listView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.not_spam_fragment, container, false);
    ...
    void deleteSelectedItems()
    {
        for(MessageClass i:selected_ids) {
            Uri uri=Uri.parse("content://com.example.asus.spam_one/not_spam_table/"+String.valueOf(i.id));
